package mbds.smartfridge.utils;
...
public class FrigoAdapterHelper implements ListAdapter {
    ...
    public FrigoAdapterHelper(Context ctx) {
        ...
        LF.add(new Frigo(1,"Samsung SMARTF","Connected",4,50,"decomp","samsung garantie 6a","180cm x 50cm x 60cm","Samsung"));
        LF.add(new Frigo(2,"LG SMRTF","Disconnected",5,50,"decomp","lg garantie 5a","180cm x 50cm x 60cm","LG"));
        LF.add(new Frigo(3,"BEKO FSMRT","Connected",6,50,"decomp","beko garantie 2a","180cm x 50cm x 60cm","Beko"));
        this.ctx = ctx;
    }
