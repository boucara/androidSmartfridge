...
public class Frigo implements Serializable {
    ...
    public Frigo(String fN, String fS){
        this.frigoName=fN;
        this.frigoStatus=fS;
    }

    public Frigo(String frigoStatus, int temperature, int humidite, String decomposition, String garantie, String dimensions, String marque) {
